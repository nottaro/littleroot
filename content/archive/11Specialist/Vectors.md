...
- The position of Vector A relative to Vector B = $_a p _b = a-b =\overrightarrow{A}-\overrightarrow{B}$
- The velocity of Vector A relative to Vector B = $_a v _b =v_a - v_b$
