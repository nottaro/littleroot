...
This version uses Quartz 4 to run. Unfortunately, a ton of my themes and callouts were destroyed, so I'm working on rebuilding it. Until then, enjoy this theme I call Cerulean!

Edit: I have no idea how to add custom CSS.

Hope you enjoy the site! I'm [nottaro](WritingsDocs/AboutMe.md)! This is a website I made as a side project! Thanks to [nottacoz](https://github.com/nottacoz) and [EddieTheEd](https://github.com/eddietheed) for helping! 

You're quite welcome, Baju's. 👍

I'm a proud member of ✨[the town](WritingsDocs/town.md)✨. ~~I have broken away from the town, along with Ed.~~ I have come back to my senses. We should have a town page coming.....Osacr is making it. These are my [sister sites](townsites.md). 
...
> [!success] Yellowstone National Park
> 
